...
namespace CT.Common.Common
{
    ...
    {
        public void SendDealClosedNotification(string token, bool status)
        {
            ...
            if (status)
                dealClosedMessage = ConfigurationManager.AppSettings["DealClosedWon"];
            else
                dealClosedMessage = ConfigurationManager.AppSettings["DealClosedLost"];
